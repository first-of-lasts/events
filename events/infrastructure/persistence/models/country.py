...
class Country(Base):
    ...
    # Relationships
    users = relationship(argument="User", back_populates="country")
    regions = relationship(argument="Region", back_populates="country")
    events = relationship(argument="Event", back_populates="country")
